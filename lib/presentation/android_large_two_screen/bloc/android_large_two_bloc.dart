...
import 'package:sabung_pinjol/presentation/android_large_two_screen/models/android_large_two_model.dart';
...
class AndroidLargeTwoBloc
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
        materialsymbolsreadmoreController: TextEditingController()));
